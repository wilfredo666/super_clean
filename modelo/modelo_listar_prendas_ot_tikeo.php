		...
		<?php
		 ...
		 while ($row_ot = pg_fetch_array($sql_ot)) {
            ...
            <tr>
			    ...
			    <input type="text" class="form-control" placeholder="Codigo Barras" id="codigo_barras_tik_<?php echo $id_orden_trabajo; ?>" onkeyup="btn_asignar_codigo_barras_tikeo('<?php echo $id_orden_trabajo; ?>','<?php echo $codigo_ot; ?>');"> 
