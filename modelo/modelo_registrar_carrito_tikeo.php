 ...
 while ($row_tik = pg_fetch_array($sql_car_tik)) {
  ...
  $sql= pg_query("INSERT INTO tikeo (id_cliente ,cliente ,id_usuario ,id_sucursal ,id_ot ,codigo_ot ,codigo_barras ,estado_tikeo ,id_prenda, codigo_tik, fecha, hora) VALUES ( '$id_cliente' , '$cliente' , '$id_usuario' , '$id_sucursal' , '$id_ot' , '$codigo_ot' , '$codigo_barras' , '$estado_tikeo' , '$id_prenda', '$codigo_tik', '$fecha', '$hora')");
